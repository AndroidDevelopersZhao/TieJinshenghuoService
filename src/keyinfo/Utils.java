...
public class Utils {
    ...
    private static int i=0;
	 ...
	 public  static Map getDecodeData(String... string) throws Exception {
		 Map<String,Object> map = new HashMap<String, Object>();
		 File file = new File("G:/MyRSAKey/privateKey_service");
			FileInputStream in = new  FileInputStream(file);
			String privatekey_c=Utils.IoToString(in);
			
		 for (String c:string) {
			 
			 byte[] data =Utils.decryptByPrivateKey(Base64Utils.decode(c), privatekey_c);
			 map.put(String.valueOf(i), new String(data).trim());
			 System.out.println("解密后："+new String(data).trim());
			 i++;
		}
		 i=0;
			return map;
    ...
    public static String IoToString(InputStream is) {
        BufferedReader reader = new BufferedReader(new InputStreamReader(is), 16*1024); //ǿ�ƻ����СΪ16KB��һ��Java��Ĭ��Ϊ8KB
